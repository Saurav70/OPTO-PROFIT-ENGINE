...
| **E2E-2** | Process Planning CRUD | 1. Navigate to `/planning`<br>2. Click "Add Task"<br>3. Fill name, duration, and predecessor<br>4. Click save | Task list updates instantly; local database sync complete |
